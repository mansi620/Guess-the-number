...
window.title("Mansi's Number Guessing Game")
 
#Mention the title of the app
title_label = Label(window, text="Mansi's Number Guessing Game\nGuess a number between 1 to 50", font=('Ubuntu Mono',18))
title_label.pack()
